 ...
 * reconciled by the first tick after resume/remount, which is why no AppState
 * foreground listener exists (see AGENTS.md, engine convention 5). A
 * decrementing counter would silently break that reconciliation.
 */
