...
- `src/theme/` — design tokens: `ActionButtonColor` (the solid-fill button colors,
  each darkened just enough to clear WCAG AA 4.5:1 against white text) and the
  pure `contrastRatio` check that verifies them
